...
ClientHandler::ClientHandler(HWND _hWnd)
{
	...
	g_graphicsEngine->getCamera()->set(FLOAT3(50.0f, 3.0f, 50.0f), FLOAT3(0.0f, -1.0f, -0.9f), FLOAT3(0.0f, 0.0f, 1.0f), FLOAT3(1.0f, 0.0f, 0.0f));
...
HRESULT ClientHandler::run()
{
	...
	this->m_state = new GameState(); // Ändra till MainMenuState
