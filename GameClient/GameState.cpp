...
GameState::GameState()
{
	...
	// Radius har för liten effekt?
	// Ambient (la) gör inget alls?
	g_graphicsEngine->createPointLight(FLOAT3(100.0f, 5.0f, 20.0f), FLOAT3(1.0f, 1.0f, 1.0f), FLOAT3(1.0f, 1.0f, 1.0f), FLOAT3(1.0f, 1.0f, 1.0f), 200000.0f);
