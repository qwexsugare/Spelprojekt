...
GameState::GameState(Client *_network)
{
	...
	//g_graphicsEngine->createDirectionalLight(FLOAT3(0.0f, 1.0f, 0.25f), FLOAT3(0.000001f, 0.000001f, 0.000001f), FLOAT3(0.000001f, 0.000001f, 0.000001f), FLOAT3(0.0f, 0.0f, 0.0f));
