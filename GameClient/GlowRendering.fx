...
{
	float4 color = glowTexture.Sample(linearSampler, input.UVCoord);
	return color;
}
...
{   
	...
	color += glowTexture.Sample(linearSampler, tex0) * weight4;
    color += glowTexture.Sample(linearSampler, tex1) * weight3;
    color += glowTexture.Sample(linearSampler, tex2) * weight2;
    color += glowTexture.Sample(linearSampler, tex3) * weight1;
    color += glowTexture.Sample(linearSampler, tex4) * weight0;
    color += glowTexture.Sample(linearSampler, tex5) * weight1;
    color += glowTexture.Sample(linearSampler, tex6) * weight2;
    color += glowTexture.Sample(linearSampler, tex7) * weight3;
    color += glowTexture.Sample(linearSampler, tex8) * weight4;
