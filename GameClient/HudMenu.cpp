...
HudMenu::HudMenu(Client *_network, Hero::HERO_TYPE _heroType)
{
	...
	this->m_shopButtons[1]->Init(FLOAT2(-0.62f, 0.4f),FLOAT2(0.079166667f,0.140740741f),m_skillHolder.getSkill(Skill::TURRET_LIFE),"3500",0,0,1,12,100,3500,INT2(422,324), false, Skill::TURRET_LIFE,"menu_textures\\Skill_1.png");
