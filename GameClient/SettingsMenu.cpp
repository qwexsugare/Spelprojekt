...
SettingsMenu::SettingsMenu()
{
	...
	this->m_Buttons[5] = new Button();
	this->m_Buttons[5]->Init(FLOAT2(-0.65f, 0.138888889f),FLOAT2(0.026041667f,0.051851852f),"menu_textures\\RadioButton.png","",0,0.4f,2,1);
	this->m_Buttons[6] = new Button();
	this->m_Buttons[6]->Init(FLOAT2(-0.5f, 0.138888889f),FLOAT2(0.026041667f,0.051851852f),"menu_textures\\RadioButton.png","",0,0.4f,2,1);
	if(m_windowed == 1)
	{
