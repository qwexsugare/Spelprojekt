...
public:
	static enum SKILLS {MOVE, ATTACK, CHAIN_STRIKE, CLOUD_OF_DARKNESS, STUNNING_STRIKE, TELEPORT, AIM, DEADLY_STRIKE, GREED, LIFESTEALING_STRIKE, MENTAL_RESISTANCE, PHYSICAL_RESISTANCE, POISON_STRIKE};
