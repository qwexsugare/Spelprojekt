...
{
	NetworkEntityMessage e = NetworkEntityMessage(this->m_id, this->m_type, this->m_modelId, (float)((float)this->m_health / (float)this->m_maxHealth) * 1000.0f, this->m_position, this->m_rotation, FLOAT3(1.0f, 1.0f, 1.0f));
